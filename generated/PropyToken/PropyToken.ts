...
export class PropyToken extends ethereum.SmartContract {
  ...
  change(_symbol: string, _name: string): boolean {
    let result = super.call("change", "change(string,string):(bool)", [
  ...
  try_change(_symbol: string, _name: string): ethereum.CallResult<boolean> {
    let result = super.tryCall("change", "change(string,string):(bool)", [
      ethereum.Value.fromString(_symbol),
      ethereum.Value.fromString(_name)
    ]);
    if (result.reverted) {
